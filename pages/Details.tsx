...
const Details: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-x-hidden">
      ...
      <div className="relative z-10 min-h-screen px-4 pb-24 pt-20 md:px-20 md:pt-24 md:pb-20">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          {/* Left Column: Poster & Actions */}
          <div className="w-full lg:w-1/4 flex flex-col gap-8">
            <div className="rounded-xl overflow-hidden shadow-2xl border-2 border-white/10 aspect-[2/3] max-w-sm mx-auto lg:max-w-none">
              <img
                ...
                <div className="flex gap-3 overflow-x-auto no-scrollbar mb-8 py-2">
                  {(content as TvDetails).seasons.map((season) => (
                    <button
                      ...
                      className={`focusable tv-focus flex-shrink-0 px-6 py-3 rounded-lg font-semibold transition-all ${selectedSeasonNumber === season.season_number

...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-16 z-50 bg-slate-950 flex flex-row md:flex-col items-center justify-around md:justify-start md:py-10 md:gap-8 border-t md:border-t-0 md:border-r border-white/10 md:w-20 md:h-full">
      ...
      {navItems.map((item) => (
        <button
          ...
          className={`focusable tv-focus p-3 rounded-full transition-colors ${location.pathname === item.path
            ? 'bg-white text-black'
